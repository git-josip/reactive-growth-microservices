...
import com.finmid.backendinterview.common.configuration.JooqConfiguration
import com.finmid.backendinterview.common.configuration.R2dbcConfiguration
...
import com.finmid.backendinterview.module.account.service.IAccountService
import com.finmid.backendinterview.module.transaction.domain.TransactionCreate
import com.finmid.backendinterview.utils.PropertyUtils
import com.finmid.backendinterview.utils.SqlTestUtils
...
class TransactionServiceTest(
    ...
    inner class UserCreation {
        @ParameterizedTest
        @MethodSource("com.finmid.backendinterview.module.transaction.service.TransactionServiceTest#accountInvalidFormattedIds")
        ...
        @ParameterizedTest
        @MethodSource("com.finmid.backendinterview.module.transaction.service.TransactionServiceTest#accountNotExistingIds")
        ...
        @ParameterizedTest
        @MethodSource("com.finmid.backendinterview.module.transaction.service.TransactionServiceTest#invalidAmounts")
        ...
        @ParameterizedTest
        @MethodSource("com.finmid.backendinterview.module.transaction.service.TransactionServiceTest#accountTransactionValidIdsAndValidAmount")
    ...
    inner class UserRetrieval {
        @ParameterizedTest
        @MethodSource("com.finmid.backendinterview.module.transaction.service.TransactionServiceTest#transactionNotExistingIds")
        ...
        @ParameterizedTest
        @MethodSource("com.finmid.backendinterview.module.transaction.service.TransactionServiceTest#transactionExistingIds")
