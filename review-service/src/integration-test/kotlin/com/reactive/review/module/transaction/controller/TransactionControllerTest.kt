package com.reactive.review.module.transaction.controller

import com.reactive.review.common.exception.dto.response.ErrorResponse
...
import com.reactive.review.module.transaction.mapper.toTransactionResponse
...
class TransactionControllerTest(
    ...
    inner class UserCreation {
        @ParameterizedTest
        @MethodSource("com.reactive.review.module.transaction.controller.TransactionControllerTest#makeTransactionAccounts")
    ...
    inner class AccountRetrieval {
        ...
        @ParameterizedTest
        @MethodSource("com.reactive.review.module.transaction.controller.TransactionControllerTest#existingTransactionIds")
