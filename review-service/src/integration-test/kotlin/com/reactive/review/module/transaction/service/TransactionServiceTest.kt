...
import com.reactive.review.common.configuration.JooqConfiguration
import com.reactive.review.common.configuration.R2dbcConfiguration
...
import com.reactive.review.module.account.service.IAccountService
import com.reactive.review.module.transaction.domain.TransactionCreate
import com.reactive.review.utils.PropertyUtils
import com.reactive.review.utils.SqlTestUtils
...
class TransactionServiceTest(
    @Autowired private val transactionService: com.reactive.review.module.transaction.service.ITransactionService,
    ...
    inner class UserCreation {
        @ParameterizedTest
        @MethodSource("com.reactive.review.module.transaction.service.TransactionServiceTest#accountInvalidFormattedIds")
        ...
        @ParameterizedTest
        @MethodSource("com.reactive.review.module.transaction.service.TransactionServiceTest#accountNotExistingIds")
        ...
        @ParameterizedTest
        @MethodSource("com.reactive.review.module.transaction.service.TransactionServiceTest#invalidAmounts")
        ...
        @ParameterizedTest
        @MethodSource("com.reactive.review.module.transaction.service.TransactionServiceTest#accountTransactionValidIdsAndValidAmount")
    ...
    inner class UserRetrieval {
        @ParameterizedTest
        @MethodSource("com.reactive.review.module.transaction.service.TransactionServiceTest#transactionNotExistingIds")
        ...
        @ParameterizedTest
        @MethodSource("com.reactive.review.module.transaction.service.TransactionServiceTest#transactionExistingIds")
