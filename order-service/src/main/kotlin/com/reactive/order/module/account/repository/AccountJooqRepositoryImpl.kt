...
import com.reactive.order.database.jooq.tables.references.ACCOUNTS
...
@Repository
class AccountJooqRepositoryImpl: com.reactive.order.module.account.repository.IAccountJooqRepository {
