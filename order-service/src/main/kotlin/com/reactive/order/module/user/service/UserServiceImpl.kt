...
import com.reactive.order.module.user.mapper.toUser
import com.reactive.order.module.user.mapper.toUsersRecord
import com.reactive.order.module.user.repository.IUserJooqRepository
import com.reactive.order.module.user.validation.UserSignupValidator
...
): com.reactive.order.module.user.service.IUserService, DslContextTransactionAware {
