package com.reactive.productcomposite.module.transaction.controller

import com.reactive.productcomposite.common.exception.dto.response.ErrorResponse
...
import com.reactive.productcomposite.module.transaction.dto.response.TransactionResponse
import com.reactive.productcomposite.module.transaction.mapper.toTransactionResponse
...
class TransactionControllerTest(
    ...
    inner class UserCreation {
        @ParameterizedTest
        @MethodSource("com.reactive.productcomposite.module.transaction.controller.TransactionControllerTest#makeTransactionAccounts")
    ...
    inner class AccountRetrieval {
        ...
        @ParameterizedTest
        @MethodSource("com.reactive.productcomposite.module.transaction.controller.TransactionControllerTest#existingTransactionIds")
