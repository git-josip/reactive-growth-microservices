...
import com.reactive.productcomposite.common.configuration.JooqConfiguration
import com.reactive.productcomposite.common.configuration.R2dbcConfiguration
...
import com.reactive.productcomposite.utils.PropertyUtils
import com.reactive.productcomposite.utils.SqlTestUtils
...
class TransactionServiceTest(
    @Autowired private val transactionService: com.reactive.productcomposite.module.transaction.service.ITransactionService,
    ...
    inner class UserCreation {
        @ParameterizedTest
        @MethodSource("com.reactive.productcomposite.module.transaction.service.TransactionServiceTest#accountInvalidFormattedIds")
        ...
        @ParameterizedTest
        @MethodSource("com.reactive.productcomposite.module.transaction.service.TransactionServiceTest#accountNotExistingIds")
        ...
        @ParameterizedTest
        @MethodSource("com.reactive.productcomposite.module.transaction.service.TransactionServiceTest#invalidAmounts")
        ...
        @ParameterizedTest
        @MethodSource("com.reactive.productcomposite.module.transaction.service.TransactionServiceTest#accountTransactionValidIdsAndValidAmount")
    ...
    inner class UserRetrieval {
        @ParameterizedTest
        @MethodSource("com.reactive.productcomposite.module.transaction.service.TransactionServiceTest#transactionNotExistingIds")
        ...
        @ParameterizedTest
        @MethodSource("com.reactive.productcomposite.module.transaction.service.TransactionServiceTest#transactionExistingIds")
