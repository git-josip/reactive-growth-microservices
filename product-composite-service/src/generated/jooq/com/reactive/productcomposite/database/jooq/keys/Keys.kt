 ...
 */
package com.reactive.productcomposite.database.jooq.keys


import com.reactive.productcomposite.database.jooq.tables.Accounts
...
import com.reactive.productcomposite.database.jooq.tables.records.FlywaySchemaHistoryRecord
...
val TRANSACTIONS__TRANSACTIONS_FROM_ACC_FKEY: ForeignKey<TransactionsRecord, AccountsRecord> = Internal.createForeignKey(Transactions.TRANSACTIONS, DSL.name("transactions_from_acc_fkey"), arrayOf(Transactions.TRANSACTIONS.FROM_ACC), com.reactive.productcomposite.database.jooq.keys.ACCOUNTS_PKEY, arrayOf(Accounts.ACCOUNTS.ID), true)
val TRANSACTIONS__TRANSACTIONS_TO_ACC_FKEY: ForeignKey<TransactionsRecord, AccountsRecord> = Internal.createForeignKey(Transactions.TRANSACTIONS, DSL.name("transactions_to_acc_fkey"), arrayOf(Transactions.TRANSACTIONS.TO_ACC), com.reactive.productcomposite.database.jooq.keys.ACCOUNTS_PKEY, arrayOf(Accounts.ACCOUNTS.ID), true)
