package com.reactive.product.module.transaction.controller
...
import com.reactive.product.module.transaction.dto.request.TransactionCreateRequest
import com.reactive.product.module.transaction.dto.response.TransactionResponse
import com.reactive.product.module.transaction.mapper.toTransactionResponse
...
class TransactionControllerTest(
    ...
    inner class UserCreation {
        @ParameterizedTest
        @MethodSource("com.reactive.product.module.transaction.controller.TransactionControllerTest#makeTransactionAccounts")
    ...
    inner class AccountRetrieval {
        ...
        @ParameterizedTest
        @MethodSource("com.reactive.product.module.transaction.controller.TransactionControllerTest#existingTransactionIds")
