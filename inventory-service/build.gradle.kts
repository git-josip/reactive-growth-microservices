...
dependencies {
	...
	implementation("io.zipkin.reporter2:zipkin-sender-okhttp3:3.4.2")
	implementation("io.zipkin.brave:brave-instrumentation-grpc:6.0.3")
	implementation("io.zipkin.brave:brave-instrumentation-kafka-clients:6.0.3")
...
jooq {
	configuration {
		...
		generator {
			...
			target {
				packageName = "com.reactive.inventory.database.jooq"
