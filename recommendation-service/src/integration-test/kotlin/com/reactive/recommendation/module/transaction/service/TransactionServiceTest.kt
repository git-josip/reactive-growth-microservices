package com.reactive.recommendation.module.transaction.service
...
class TransactionServiceTest(
    ...
    inner class UserCreation {
        @ParameterizedTest
        @MethodSource("com.reactive.recommendation.module.transaction.service.TransactionServiceTest#accountInvalidFormattedIds")
        ...
        @ParameterizedTest
        @MethodSource("com.reactive.recommendation.module.transaction.service.TransactionServiceTest#accountNotExistingIds")
        ...
        @ParameterizedTest
        @MethodSource("com.reactive.recommendation.module.transaction.service.TransactionServiceTest#invalidAmounts")
        ...
        @ParameterizedTest
        @MethodSource("com.reactive.recommendation.module.transaction.service.TransactionServiceTest#accountTransactionValidIdsAndValidAmount")
    ...
    inner class UserRetrieval {
        @ParameterizedTest
        @MethodSource("com.reactive.recommendation.module.transaction.service.TransactionServiceTest#transactionNotExistingIds")
        ...
        @ParameterizedTest
        @MethodSource("com.reactive.recommendation.module.transaction.service.TransactionServiceTest#transactionExistingIds")
